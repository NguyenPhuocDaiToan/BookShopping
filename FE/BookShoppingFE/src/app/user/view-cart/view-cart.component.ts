...
export class ViewCartComponent implements OnInit {
  ...
  constructor(private cartService: CartService, private storageService: TokenStorageService, private spinner: NgxSpinnerService,
  ...
  paymentSuccess() {
    ...
    this.orderService.order(this.storageService.getUser().id, this.totalPrice, orderItems).subscribe(
      next => {
